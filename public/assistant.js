...
(function () {
  ...
  var KB = [
    ...
    'A 15% overlap deduction is applied to carrying-cost savings to avoid double-counting (disclosed in footnotes). Benefits ramp in over years 1–3. Payback is when cumulative benefit exceeds the investment. The model is server-authoritative — figures are recomputed on save and cannot be altered client-side.',
    '',
    ...
    '- Annual inventory value ($): total inventory on hand at any time. Drives the carrying-cost and shrinkage levers.',
  ...
  var FIELD_LABELS = {
    ...
    inventoryValue:'Annual inventory value', itCost:'Current IT / legacy cost per year',
