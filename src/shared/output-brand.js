...
function pptFooter(slide,audience='customer',{dark=false}={}){const t=brand.officeTheme();slide.addText(brand.audience(audience),{x:4.8,y:t.H-.3,w:4.75,h:.15,fontFace:t.FONT,fontSize:7,color:dark?t.WHITE:t.GRAY_TXT,align:'right'});}
